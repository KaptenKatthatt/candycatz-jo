...
<div class="modal fade" id="candyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm-sm">
      ...
      <h3 class="modal-title">${candyTitle}</h3>
        <button type="button" class="btn modal-btn me-0" data-bs-dismiss="modal" aria-label="Close">X
        </button>
        </div>
        <div class="modal-body mt-0">
        <div class="row">    
        <div class="col-sm-6 d-flex align-items-center">
          <img src="${modalThumbnailURL}" class="modalThumbnail modal-card-img scallopbox-thumb" alt="${candyTitle}">
          </div>
          ...
          <button type="button" class="btn modal-btn modal-btn mt-2" data-bs-dismiss="modal" aria-label="Close product info popup">Stäng</button>
